    ...
    <div class="page-content faq">
      <div class="container">
        <section class="content-title-section">
          <h3 class="title title-simple justify-content-center bb-no pb-0">Frequent Asked Questions</h3>
          <p class="description text-center">You can show the faqs with <b>Zomex Elements</b> easily.</p>
        </section>
