...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #ffffff;color: #000000">
    ...
    @php
        $generalInfo = DB::table('general_infos')->where('id', 1)->select('logo_dark', 'company_name', 'contact', 'email', 'address', 'facebook', 'twitter', 'linkedin', 'youtube', 'messenger', 'whatsapp', 'telegram')->first();
