              ...
              <div class="auth-card-form-body">
                <form class="auth-card-form" action="#" method="post">
                  ...
                  <div class="auth-card-info">
                    <div class="form-check"><input type="checkbox" id="custom-checkbox" class="form-check-input" /><label title="" for="custom-checkbox" class="form-check-label">Remember me</label></div>
                    <a href="forget-password.html">Forgotten password?</a>
                  </div>
                  <a type="submit" href="./user-dashboard/dashboard.html" class="auth-card-form-btn primary__btn"> Sign in </a>
                </form>
                <div class="auth-card-bottom">
                  <span>or</span>
                  <div class="auth-card-google-btn">
                    <a target="_blank" href="#"><img src="{{url('assets')}}/images/icons/google.svg" alt="#" />Sign in with Google</a>
                  </div>
                  <p class="auth-card-bottom-link">Don’t have any account?<a href="register.html">Register account</a></p>
                </div>
              </div>
            </div>
          </div>
