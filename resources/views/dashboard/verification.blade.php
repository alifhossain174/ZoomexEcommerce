                    ...
                    <div class="auth-card verifyOTP-card">
                        <div class="auth-card-head">
                            ...
                            <p class="auth-card-head-title-text">
                                ...
                                <span class="otp-number">"{{ Auth::user()->email ? Auth::user()->email : Auth::user()->phone }}"</span>
                        ...
                        <div class="auth-card-bottom">
                            ...
                            <p class="OTP-send-again m-0 text-center">
                                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="border: 1px solid var(--secondary-color); padding: 8px 15px; border-radius: 4px;"><i class="fa fa-arrow-left" style="font-size: 12px"></i> Go Back</a>
                            </p>
