                ...
                <div class="col-lg-12 col-xl-9 col-12">
                    <div class="dasboard-data-card mgTop24">
                        ...
                        <div class="single-data-card card-5">
                            ...
                            <div class="data-card-icon">
                                <img alt="" src="{{ url('assets') }}/images/dashboard-data-card-images/icon-5.svg" />
                            </div>
                        </div>
                        <div class="single-data-card card-6">
                            ...
                            <div class="data-card-icon">
                                <img alt="" src="{{url('assets')}}/images/dashboard-data-card-images/support-ticket.svg" />
                            </div>
                        </div>
                    </div>
                                        ...
                                        @foreach ($recentOrders as $recentOrder)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <strong class="product-date" style="font-size: 15px; font-style: normal; font-weight: 600;">{{ date('jS M, Y h:i A', strtotime($recentOrder->order_date)) }}</strong>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="product-quantity">
                                                        Qty: {{ DB::table('order_details')->where('order_id', $recentOrder->id)->sum('qty') }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="product-price">
                                                        Amount: {{ number_format($recentOrder->total) }} BDT
                                                    </span>
                                                </td>
                                                <td>
...
@section('footer_js')
    ...
    <script src="{{url('assets')}}/js/modernizer.min.js"></script>
