    ...
    <main class="main">
        ...
        <div class="page-content error-404">
            <div class="container">
                <div class="banner">
                    <figure>
                        <img src="{{url('assets')}}/images/pages/404.png" alt="Error 404" width="820" height="460" />
                    </figure>
                    <div class="banner-content text-center">
                        ...
                        <a href="index.html" class="btn btn-dark btn-rounded btn-icon-right">Go Back Home<i
