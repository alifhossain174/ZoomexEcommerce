            ...
            <ul class="product-nav list-style-none">
                <li class="product-nav-prev">
                    ...
                    <span class="product-nav-popup">
                        <img src="{{ url('assets') }}/images/products/product-nav-prev.jpg" alt="Product" width="110"
                            height="110" />
                ...
                <li class="product-nav-next">
                    ...
                    <span class="product-nav-popup">
                        <img src="{{ url('assets') }}/images/products/product-nav-next.jpg" alt="Product" width="110"
                            height="110" />
                                        ...
                                        <div class="swiper-wrapper row cols-1 gutter-no">
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{ url('assets') }}/images/products/default/1-800x900.jpg"
                                                        data-zoom-image="{{url('assets')}}/images/products/default/1-800x900.jpg"
                                                        alt="Electronics Black Wrist Watch" width="800" height="900" />
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{url('assets')}}/images/products/default/2-800x900.jpg"
                                                        data-zoom-image="{{url('assets')}}/images/products/default/2-800x900.jpg"
                                                        alt="Electronics Black Wrist Watch" width="488" height="549" />
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{url('assets')}}/images/products/default/3-800x900.jpg"
                                                        data-zoom-image="{{url('assets')}}/images/products/default/3-800x900.jpg"
                                                        alt="Electronics Black Wrist Watch" width="800" height="900" />
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{url('assets')}}/images/products/default/4-800x900.jpg"
                                                        data-zoom-image="{{url('assets')}}/images/products/default/4-800x900.jpg"
                                                        alt="Electronics Black Wrist Watch" width="800" height="900" />
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{url('assets')}}/images/products/default/5-800x900.jpg"
                                                        data-zoom-image="{{url('assets')}}/images/products/default/5-800x900.jpg"
                                                        alt="Electronics Black Wrist Watch" width="800" height="900" />
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{url('assets')}}/images/products/default/6-800x900.jpg"
                                                        data-zoom-image="{{url('assets')}}/images/products/default/6-800x900.jpg"
                                                        alt="Electronics Black Wrist Watch" width="800" height="900" />
                                                </figure>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-thumbs-wrap swiper-container"
                                        ...
                                        <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                                            <div class="product-thumb swiper-slide">
                                                <img src="{{url('assets')}}/images/products/default/1-800x900.jpg" alt="Product Thumb"
                                                    width="800" height="900" />
                                            </div>
                                            <div class="product-thumb swiper-slide">
                                                <img src="{{url('assets')}}/images/products/default/2-800x900.jpg" alt="Product Thumb"
                                                    width="800" height="900" />
                                            </div>
                                            <div class="product-thumb swiper-slide">
                                                <img src="{{url('assets')}}/images/products/default/3-800x900.jpg" alt="Product Thumb"
                                                    width="800" height="900" />
                                            </div>
                                            <div class="product-thumb swiper-slide">
                                                <img src="{{url('assets')}}/images/products/default/4-800x900.jpg" alt="Product Thumb"
                                                    width="800" height="900" />
                                            </div>
                                            <div class="product-thumb swiper-slide">
                                                <img src="{{url('assets')}}/images/products/default/5-800x900.jpg"
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-5">
                                            ...
                                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                                do eiusmod tempor incididunt arcu cursus vitae congue mauris. Sagittis id
                                                consectetur purus ut. Tellus rutrum tellus pelle Vel pretium lectus quam id
                                                leo in vitae turpis massa.</p>
                                        ...
                                        <div class="col-md-6 mb-5">
                                            <div class="banner banner-video product-video br-xs">
                                                <figure class="banner-media">
                                                    <a href="#">
                                                        <img src="{{url('assets')}}/images/products/video-banner-610x300.jpg"
                                                            alt="banner" width="610" height="300"
                                                            style="background-color: #bebebe" />
                                                    </a>
                                                    <a class="btn-play-video btn-iframe"
                                                        href="{{url('assets')}}/video/memory-of-a-woman.mp4"></a>
                                                </figure>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="product-tab-vendor">
                                    <div class="row mb-3">
                                        <div class="col-md-6 mb-4">
                                            <figure class="vendor-banner br-sm">
                                                <img src="{{url('assets')}}/images/products/vendor-banner.jpg" alt="Vendor Banner"
                                        ...
                                        <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                            <div class="vendor-user">
                                                <figure class="vendor-logo mr-4">
                                                    <a href="#">
                                                        <img src="{{url('assets')}}/images/products/vendor-logo.jpg"
                                    ...
                                    <p class="mb-5"><strong class="text-dark">L</strong>orem ipsum dolor sit amet,
                                        ...
                                        magna aliqua. Venenatis tellus in metus vulputate eu scelerisque felis. Vel pretium
                                        lectus quam id leo in vitae turpis massa. Nunc id cursus metus aliquam. Libero id
                                        faucibus nisl tincidunt eget. Aliquam id diam maecenas ultricies mi eget mauris.
                                        Volutpat ac tincidunt vitae semper quis lectus. Vestibulum mattis ullamcorper velit
                                        sed. A arcu cursus vitae congue mauris.</p>
                                    <p class="mb-2"><strong class="text-dark">A</strong> arcu cursus vitae congue
                                        mauris. Sagittis id consectetur purus ut. Tellus rutrum tellus pellentesque eu
                                        tincidunt tortor aliquam nulla. Diam in arcu cursus euismod quis. Eget sit amet
                                        tellus cras adipiscing enim eu. In fermentum et sollicitudin ac orci phasellus. A
                                        condimentum vitae sapien pellentesque habitant morbi tristique senectus et. In
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-xl-4 col-lg-5 mb-4">
                                            <div class="ratings-wrapper">
                                                ...
                                                <div class="ratings-value d-flex align-items-center text-dark ls-25"><span
                                                        class="text-dark font-weight-bold">66.7%</span>Recommended<span
                                                        class="count">(2 of 3)</span></div>
                                            ...
                                            <div class="tab-pane active" id="show-all">
                                                <ul class="comments list-style-none">
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="{{url('assets')}}/images/agents/1-100x100.png"
                                                            ...
                                                            <div class="comment-content">
                                                                ...
                                                                <div class="comment-action">
                                                                    ...
                                                                    <div class="review-image">
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{url('assets')}}/images/products/default/review-img-1.jpg"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{url('assets')}}/images/products/default/review-img-1-800x900.jpg" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="{{url('assets')}}/images/agents/2-100x100.png"
                                                                    alt="Commenter Avatar" width="90"
                                                                    height="90" />
                                                            </figure>
                                                            <div class="comment-content">
                                                                ...
                                                                <p>Nullam a magna porttitor, dictum risus nec, faucibus
                                                                    ...
                                                                    ante in nibh mauris cursus mattis. Cras ornare arcu dui
                                                                    vivamus arcu felis bibendum ut tristique.</p>
                                                                <div class="comment-action">
                                                                    <a href="#"
                                                                        class="btn btn-secondary btn-link btn-underline sm btn-icon-left font-weight-normal text-capitalize">
                                                                        <i class="far fa-thumbs-up"></i>Helpful (1) </a>
                                                                    ...
                                                                    <div class="review-image">
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{url('assets')}}/images/products/default/review-img-2.jpg"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{url('assets')}}/images/products/default/review-img-2.jpg" />
                                                                            </figure>
                                                                        </a>
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{url('assets')}}/images/products/default/review-img-3.jpg"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{url('assets')}}/images/products/default/review-img-3.jpg" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="{{url('assets')}}/images/agents/3-100x100.png"
                                                                    alt="Commenter Avatar" width="90"
                                                                    height="90" />
                                                            </figure>
                                                            <div class="comment-content">
                                                                ...
                                                                <div class="comment-action">
                                                                    <a href="#"
                                                                        class="btn btn-secondary btn-link btn-underline sm btn-icon-left font-weight-normal text-capitalize">
                                                                        <i class="far fa-thumbs-up"></i>Helpful (0) </a>
                                                                    <a href="#"
                                                                        class="btn btn-dark btn-link btn-underline sm btn-icon-left font-weight-normal text-capitalize">
                                                                        ...
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{url('assets')}}/images/products/default/review-img-1.jpg"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{url('assets')}}/images/products/default/review-img-1.jpg" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{url('assets')}}/images/products/default/review-img-2.jpg"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{url('assets')}}/images/products/default/review-img-2-800x900.jpg" />
                                                                            </figure>
                                                                        </a>
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{url('assets')}}/images/products/default/review-img-3.jpg"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{url('assets')}}/images/products/default/review-img-3-800x900.jpg" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="sticky-sidebar">
                                ...
                                <div class="widget widget-banner mb-9">
                                    <div class="banner banner-fixed br-sm">
                                        <figure>
                                            <img src="{{url('assets')}}/images/shop/banner3.jpg" alt="Banner" width="266"
                                                height="220" style="background-color: #1d2d44" />
                                        </figure>
                                        <div class="banner-content">
                                            <div class="banner-price-info font-weight-bolder text-white lh-1 ls-25">40<sup
                                                    class="font-weight-bold">%</sup><sub
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="widget-col swiper-slide">
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{url('assets')}}/images/shop/13.jpg" alt="Product"
                                                    ...
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{url('assets')}}/images/shop/14.jpg" alt="Product"
                                                                    width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                    ...
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{url('assets')}}/images/shop/15.jpg" alt="Product"
                                                                    width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                ...
                                                <div class="widget-col swiper-slide">
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{url('assets')}}/images/shop/16.jpg" alt="Product"
                                                                    width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                    ...
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{url('assets')}}/images/shop/17.jpg" alt="Product"
                                                                    width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                    ...
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{url('assets')}}/images/shop/18.jpg" alt="Product"
                                                                    width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
