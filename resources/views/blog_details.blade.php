          ...
          <div class="main-content post-single-content">
            <div class="post post-grid post-single">
              <figure class="post-media br-sm">
                <img src="{{ url('assets') }}/images/blog/single/1.jpg" alt="Blog" width="930" height="500" />
              </figure>
              <div class="post-details">
                ...
                <div class="post-content">
                  <p>Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh. Suspendisse potenti. Sed egstas, ant at vulputate volutpat, uctus metus libero eu augue, vitae luctus metus libero eu augue.</p>
                  <p>
            ...
            <!-- End Blockquote -->
            <p class="mb-10">Morbi interdum mollis sapien. Sed ac risus. Pha sellus lacinia, magna a laoreet, lect us arcu pulvinar risus, vitae fac ilisis libeo dolor. Sed vel lacus. Mauris nibh felis, adipiscing varius, adipiscing in, lacinia vel, tellus. Suspendisse ac urna.</p>
            <h4 class="title title-md font-weight-bold">Defaulting to Mindfulness: The Third Person Effect</h4>
            <p class="mb-2">Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, da pibus id, mattis vel, nisi. Sed pretium, ligula soll itudin laoreet viverra. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultric sagittis, mi neque euismod duin.</p>
            ...
            <div class="post-author-detail">
              <figure class="author-media mr-4">
                <img src="{{ url('assets') }}/images/blog/single/1.png" alt="Author" width="105" height="105" />
              </figure>
            ...
            <div class="swiper">
              <div
                class="post-slider swiper-container swiper-theme nav-top pb-2"
                data-swiper-options="{
                                'spaceBetween': 20,
                                'slidesPerView': 1,
                                'breakpoints': {
              ...
              >
                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-xs-2 cols-1">
                  <div class="swiper-slide post post-grid">
                    <figure class="post-media br-sm">
                      <a href="blog-details.html">
                        <img src="{{ url('assets') }}/images/blog/single/2.jpg" alt="Post" width="296" height="190" style="background-color: #bcbcb4" />
                      </a>
                    </figure>
                    <div class="post-details text-center">
                      ...
                      <h4 class="post-title mb-3">
                        <a href="blog-details.html">Fashion tell about who you are from...</a>
                      </h4>
                      <a href="blog-details.html" class="btn btn-link btn-dark btn-underline font-weight-normal">Read More<i class="w-icon-long-arrow-right"></i></a>
                    </div>
                  </div>
                  <div class="swiper-slide post post-grid">
                    <figure class="post-media br-sm">
                      <a href="blog-details.html">
                        <img src="{{ url('assets') }}/images/blog/single/3.jpg" alt="Post" width="296" height="190" style="background-color: #cad2d1" />
                      </a>
                    </figure>
                    <div class="post-details text-center">
                      <div class="post-meta">
                        by
                        <a href="#" class="post-author">Hilary Kreton</a> -
                        <a href="#" class="post-date">03.05.2021</a>
                      </div>
                      <h4 class="post-title mb-3">
                        <a href="blog-details.html">Comes a cool blog post with Images</a>
                      </h4>
                      <a href="blog-details.html" class="btn btn-link btn-dark btn-underline font-weight-normal">Read More<i class="w-icon-long-arrow-right"></i></a>
                    </div>
                  </div>
                  <div class="swiper-slide post post-grid">
                    <figure class="post-media br-sm">
                      <a href="blog-details.html">
                        <img src="{{ url('assets') }}/images/blog/single/4.jpg" alt="Post" width="296" height="190" style="background-color: #ececec" />
                      </a>
                    </figure>
                    <div class="post-details text-center">
                      <div class="post-meta">
                        by
                        <a href="#" class="post-author">Casper Dailn</a> -
                        <a href="#" class="post-date">03.05.2021</a>
                      </div>
                      <h4 class="post-title mb-3">
                        <a href="blog-details.html">Comes a cool blog post with Images</a>
                  ...
                  <div class="swiper-slide post post-grid">
                    <figure class="post-media br-sm">
                      <a href="blog-details.html">
                        <img src="{{ url('assets') }}/images/blog/single/5.jpg" alt="Post" width="296" height="190" style="background-color: #afafaf" />
                      </a>
                    </figure>
                    <div class="post-details text-center">
                      <div class="post-meta">
                      ...
                      <h4 class="post-title mb-3">
                        <a href="blog-details.html">We want to be different and fashion gives to me that outlet</a>
                      </h4>
                      <a href="blog-details.html" class="btn btn-link btn-dark btn-underline font-weight-normal">Read More<i class="w-icon-long-arrow-right"></i></a>
                    </div>
                  </div>
            ...
            <ul class="comments list-style-none pl-0">
              <li class="comment">
                <div class="comment-body">
                  <figure class="comment-avatar">
                    <img src="{{ url('assets') }}/images/blog/single/1.png" alt="Avatar" width="90" height="90" />
                  </figure>
              ...
              <li class="comment">
                <div class="comment-body">
                  <figure class="comment-avatar">
                    <img src="{{ url('assets') }}/images/blog/single/2.png" alt="Avatar" width="90" height="90" />
                  </figure>
                  <div class="comment-content">
                    <h4 class="comment-author font-weight-bold">
                      <a href="#">Semi Colon</a>
            ...
            <div class="sidebar-content">
              <div class="sticky-sidebar">
                        ...
                        <div class="swiper-wrapper row cols-1">
                          <div class="swiper-slide widget-col">
                            <div class="post-widget mb-4">
                              <figure class="post-media br-sm">
                                <img src="{{ url('assets') }}/images/blog/sidebar/1.jpg" alt="150" height="150" />
                              </figure>
                              <div class="post-details">
                                <div class="post-meta">
                                ...
                                <h4 class="post-title">
                                  <a href="blog-details.html">Fashion tells about who you are from external point</a>
                                </h4>
                              </div>
                            </div>
                            <div class="post-widget mb-4">
                              <figure class="post-media br-sm">
                                <img src="{{ url('assets') }}/images/blog/sidebar/2.jpg" alt="150" height="150" />
                              </figure>
                              <div class="post-details">
                                <div class="post-meta">
                                ...
                                <h4 class="post-title">
                                  <a href="blog-details.html">New found the men dress for summer</a>
                                </h4>
                              </div>
                            </div>
                            <div class="post-widget mb-2">
                              <figure class="post-media br-sm">
                                <img src="{{ url('assets') }}/images/blog/sidebar/3.jpg" alt="150" height="150" />
                              </figure>
                              <div class="post-details">
                                <div class="post-meta">
                                  <a href="#" class="post-date">March 1, 2021</a>
                                ...
                                <h4 class="post-title">
                                  <a href="blog-details.html">Cras ornare tristique elit</a>
                                </h4>
                              </div>
                            </div>
                          </div>
                          <div class="swiper-slide widget-col">
                            <div class="post-widget mb-4">
                              <figure class="post-media br-sm">
                                <img src="{{ url('assets') }}/images/blog/sidebar/4.jpg" alt="150" height="150" />
                              </figure>
                              <div class="post-details">
                                <div class="post-meta">
                                  <a href="#" class="post-date">March 1, 2021</a>
                                ...
                                <h4 class="post-title">
                                  <a href="blog-details.html">Vivamus vestibulum ntulla nec ante</a>
                                </h4>
                              </div>
                            </div>
                            <div class="post-widget mb-4">
                              <figure class="post-media br-sm">
                                <img src="{{ url('assets') }}/images/blog/sidebar/5.jpg" alt="150" height="150" />
                              </figure>
                              <div class="post-details">
                                <div class="post-meta">
                                  <a href="#" class="post-date">March 5, 2021</a>
                                ...
                                <h4 class="post-title">
                                  <a href="blog-details.html">Fusce lacinia arcuet nulla</a>
                                </h4>
                              </div>
                            </div>
                            <div class="post-widget mb-2">
                              <figure class="post-media br-sm">
                                <img src="{{ url('assets') }}/images/blog/sidebar/6.jpg" alt="150" height="150" />
                              </figure>
                              <div class="post-details">
                                <div class="post-meta">
                                  <a href="#" class="post-date">March 1, 2021</a>
                ...
                <div class="widget widget-custom-block">
                  ...
                  <div class="widget-body">
                    <p class="text-default mb-0">Fringilla urna porttitor rhoncus dolor purus. Luctus veneneratis lectus magna fring. Suspendisse potenti. Sed egestas, ante et vulputate volutpat, uctus metus libero.</p>
                  </div>
                </div>
