                  ...
                  <td class="product-thumbnail">
                    <div class="p-relative">
                      <a href="product-details.html">
                        <figure>
                          <img src="{{url('assets')}}/images/shop/12.jpg" alt="product" width="300" height="338" />
                        </figure>
                      </a>
                ...
                <tr>
                  <td class="product-thumbnail">
                    <div class="p-relative">
                      <a href="product-details.html">
                        <figure>
                          <img src="{{url('assets')}}/images/shop/13.jpg" alt="product" width="300" height="338" />
                        </figure>
                      </a>
                  ...
                  <td class="product-name">
                    <a href="product-details.html"> Smart Watch </a>
                  </td>
                  <td class="product-price">
          ...
          <div class="col-lg-4 sticky-sidebar-wrapper">
            <div class="sticky-sidebar">
              <div class="cart-summary mb-4">
                ...
                <a href="#" class="btn btn-block btn-dark btn-icon-right btn-rounded btn-checkout"> Proceed to checkout<i class="w-icon-long-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
