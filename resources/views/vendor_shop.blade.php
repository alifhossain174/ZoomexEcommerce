            ...
            <div class="row cols-sm-2">
                ...
                <div class="store store-grid store-wcfm">
                  ...
                  <div class="store-content">
                    <h4 class="store-title">
                      <a href="{{ url('/vendor-shop-details') }}">Vendor 1</a>
                    </h4>
                  ...
                  <div class="store-footer">
                    <figure class="seller-brand">
                      <img src="{{url('assets')}}/images/vendor/brand/1.jpg" alt="Brand" width="80" height="80" />
                    </figure>
              ...
              <div class="store-wrap mb-4">
                <div class="store store-grid store-wcfm">
                  <div class="store-header">
                    <figure class="store-banner">
                      <img src="{{url('assets')}}/images/vendor/dokan/2.jpg" alt="Vendor" width="400" height="194" style="background-color: #40475e" />
                    </figure>
                  </div>
                  <!-- End of Store Header -->
                  <div class="store-content">
                    <h4 class="store-title">
                      <a href="{{ url('/vendor-shop-details') }}">Vendor 2</a>
                    </h4>
                    <div class="ratings-container">
                      <div class="ratings-full">
                        <span class="ratings" style="width: 100%"></span>
                  ...
                  <div class="store-footer">
                    <figure class="seller-brand">
                      <img src="{{url('assets')}}/images/vendor/brand/2.jpg" alt="Brand" width="80" height="80" />
                    </figure>
                    <a href="#" class="btn btn-inquiry btn-rounded btn-icon-left"><i class="far fa-question-circle"></i>Inquiry</a>
                    <a href="#" class="btn btn-rounded btn-visit">Visit</a>
                  </div>
              ...
              <div class="store-wrap mb-4">
                <div class="store store-grid store-wcfm">
                  <div class="store-header">
                    <figure class="store-banner">
                      <img src="{{url('assets')}}/images/vendor/dokan/3.jpg" alt="Vendor" width="400" height="194" style="background-color: #40475e" />
                    </figure>
                  </div>
                  <!-- End of Store Header -->
                  <div class="store-content">
                    <h4 class="store-title">
                      <a href="{{ url('/vendor-shop-details') }}">Vendor 3</a>
                    </h4>
                    <div class="ratings-container">
                      <div class="ratings-full">
                        <span class="ratings" style="width: 100%"></span>
                  ...
                  <div class="store-footer">
                    <figure class="seller-brand">
                      <img src="{{url('assets')}}/images/vendor/brand/3.jpg" alt="Brand" width="80" height="80" />
                    </figure>
                    <a href="#" class="btn btn-inquiry btn-rounded btn-icon-left"><i class="far fa-question-circle"></i>Inquiry</a>
                    <a href="#" class="btn btn-rounded btn-visit">Visit</a>
                  </div>
              ...
              <div class="store-wrap mb-4">
                <div class="store store-grid store-wcfm">
                  <div class="store-header">
                    <figure class="store-banner">
                      <img src="{{url('assets')}}/images/vendor/dokan/4.jpg" alt="Vendor" width="400" height="194" style="background-color: #40475e" />
                    </figure>
                  </div>
                  <!-- End of Store Header -->
                  <div class="store-content">
                    <h4 class="store-title">
                      <a href="{{ url('/vendor-shop-details') }}">Vendor 4</a>
                    </h4>
                    <div class="ratings-container">
                      <div class="ratings-full">
                        <span class="ratings" style="width: 100%"></span>
                  ...
                  <div class="store-footer">
                    <figure class="seller-brand">
                      <img src="{{url('assets')}}/images/vendor/brand/4.jpg" alt="Brand" width="80" height="80" />
                    </figure>
                    <a href="#" class="btn btn-inquiry btn-rounded btn-icon-left"><i class="far fa-question-circle"></i>Inquiry</a>
                    <a href="#" class="btn btn-rounded btn-visit">Visit</a>
                  </div>
