...
@section('content')
    <main class="main">
        ...
        <div class="page-content become-a-vendor">
            <div class="container create-store pb-1 pb-lg-10 mb-10">
                <div class="row align-items-center">
                    <div class="col-md-6 mb-4 mb-md-0">
                        <figure class="br-sm">
                            <img src="{{ url('assets') }}/images/pages/become/1.jpg" alt="Banner" width="610"
                                height="435" style="background-color: #d9d8dd" />
                        </figure>
                    </div>
                    <div class="col-md-6 order-md-first">
                        <h4 class="text-primary font-weight-bold ls-25">Create a Store</h4>
                        <h2 class="title text-left">Build your online store on Zomex</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididunt ut labore et
                            dolore magna aliqua. Venenatis tellus in metus vulputate eu scelerisque felis.</p>
                        <a href="vendor-register.html"
                            class="btn btn-dark btn-primary btn-rounded btn-icon-right ls-25 mr-3">Register Now <i
                                class="w-icon-long-arrow-right"></i></a>
                        <a href="login.html" class="btn btn-dark btn-outline btn-rounded ls-25">Sign In</a>
                    </div>
                </div>
                <!-- End of Row -->
            </div>
                ...
                <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                    <div class="row align-items-center">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <figure class="br-sm">
                                <img src="{{ url('assets') }}/images/pages/become/2.jpg" alt="Banner" width="610"
                            ...
                            <div class="row cols-sm-2 mb-1">
                                <div class="stage-item mb-6 stage-register d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        id="Layer_4" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70"
                                        xml:space="preserve">
                                        <g>
                                ...
                                <div class="stage-item mb-6 stage-selling d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        id="Layer_3" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70"
                                        xml:space="preserve">
                                        <g>
                                ...
                                <div class="stage-item mb-5 stage-get d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        id="Layer_2" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70"
                                        xml:space="preserve">
                                        <g>
                                            <path
                ...
                <div class="row">
                    <div class="col-sm-6 listing-fee">
                        <div class="counter text-center">
                            ...
                            <h4>Listing Fee</h4>
                            <p>Diam maecenas ultricies mi eget mauris Nibh tellus molestie nunc non</p>
                        </div>
                    </div>
            ...
            <div class="bg-grey pt-2 pt-lg-10 Zomex-sellers pb-10">
                <div class="container mt-0 mt-lg-10 mb-2 mb-lg-9">
                    <div class="row">
                        <div class="col-lg-4 mb-4 mb-lg-0">
                            <h4 class="text-primary font-weight-bold ls-25">What they say</h4>
                            <h2 class="title text-left ls-25">Success stories from Zomex sellers</h2>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing hendrerit. Pellentesque aliquet nibh nec
                                urna dolor sit In nisi dapibus id, mattis</p>
                            <a href="vendor-shop-details.html" class="btn btn-dark btn-link btn-underline btn-icon-right">
                                            ...
                                            <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                <div class="testimonial-info">
                                                    <figure class="testimonial-author-thumbnail">
                                                        <img src="{{url('assets')}}/images/agents/1-100x100.png" alt="Testimonial"
                                                ...
                                                <blockquote>Lorem ipsum dolor sit amet, consectetuerd do Pellentesque
                                                    aliquet nib Nullamer mnequtesq nibhue aliquet urnaIn mattis...
                                                </blockquote>
                                                <cite class="ls-25"> Victoria Ventura<span>Investor</span> </cite>
                                            </div>
                                        </div>
                                        <div class="swiper-slide testimonial-wrap">
                                            <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                <div class="testimonial-info">
                                                    <figure class="testimonial-author-thumbnail">
                                                        <img src="{{url('assets')}}/images/agents/2-100x100.png" alt="Testimonial"
                                                            width="100" height="100" />
                                                    </figure>
                                                    <div class="ratings-container">
                                                        <div class="ratings-full">
                                                ...
                                                <cite class="ls-25"> Henry Harry<span>Investor</span> </cite>
                                            </div>
                                        </div>
                                        <div class="swiper-slide testimonial-wrap">
                                            <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                <div class="testimonial-info">
                                                    <figure class="testimonial-author-thumbnail">
                                                        <img src="{{url('assets')}}/images/agents/3-100x100.png" alt="Testimonial"
                                                            width="100" height="100" />
                                                    </figure>
                                                    <div class="ratings-container">
                                                        <div class="ratings-full">
                                                ...
                                                <cite class="ls-25"> Anna Miranda<span>Investor</span> </cite>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Venenatis tellus in metus vulputate eu scelerisquefelis. Vel
                            pretium lectus quam id leo in vitae turpis massa.</p>
                        <h4 class="font-weight-bold ls-25">How can I know stock?</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Venenatis tellus.</p>
                    </div>
                    <div class="col-md-6">
                        <h4 class="font-weight-bold ls-25">How do I get paid?</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Venenatis tellus in metus vulputate eu scelerisquefelis.</p>
            ...
            <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}"
                data-image-src="{{url('assets')}}/images/pages/become/3.jpg" style="background-color: #929294">
                <div class="container">
                    <div class="banner-content text-center">
                        <h2 class="title title-center text-white font-weight-bold">Let’s talk about how we can make brands
                            work for you</h2>
