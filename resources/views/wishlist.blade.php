              ...
              <td class="product-thumbnail">
                <div class="p-relative">
                  <a href="product-details.html">
                    <figure>
                      <img src="{{url('assets')}}/images/shop/7-1.jpg" alt="product" width="300" height="338" />
                    </figure>
                  </a>
            ...
            <tr>
              <td class="product-thumbnail">
                <div class="p-relative">
                  <a href="product-details.html">
                    <figure>
                      <img src="{{url('assets')}}/images/shop/19-1.jpg" alt="product" width="300" height="338" />
                    </figure>
                  </a>
                  <button type="submit" class="btn btn-close">
                    <i class="fas fa-times"></i>
              ...
              <td class="product-name">
                <a href="product-details.html"> Handmade Ring </a>
              </td>
              <td class="product-price">
            ...
            <tr>
              <td class="product-thumbnail">
                <div class="p-relative">
                  <a href="product-details.html">
                    <figure>
                      <img src="{{url('assets')}}/images/shop/20.jpg" alt="product" width="300" height="338" />
                    </figure>
                  </a>
                  <button type="submit" class="btn btn-close">
                    <i class="fas fa-times"></i>
              ...
              <td class="product-name">
                <a href="product-details.html"> Pencil Case </a>
              </td>
              <td class="product-price">
